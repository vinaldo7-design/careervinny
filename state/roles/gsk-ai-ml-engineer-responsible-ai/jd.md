---
source-url: https://gsk.wd5.myworkdayjobs.com/GSKCareers/job/London-The-Stanley-Building/AI-ML-Engineer--Responsible-AI_443338
company: GSK
title: AI/ML Engineer, Responsible AI
...
We are looking for a researcher with a track record in successfully developing and publishing state-of-the-art AI/ML methods, preferably with a focus on foundation models and their evaluation. In addition to outstanding ML engineering and research skills, ideal candidates will demonstrate a keen interest in ethical and safety aspects of using AI in drug discovery and the clinic.
...
- Perform and publish ML research for the evaluation and development of biomedical foundation models, on various healthcare modalities (including multimodal).

- Develop and implement ML methods to solve applied problems at the interface of biomedical foundation models, drug discovery and challenging biomedical datasets.
...
- A strong foundation in machine learning and experience with state-of-the-art modelling approaches, especially foundation models.
...
**Closing Date for Applications: Monday 6th July 2026 (COB)**
